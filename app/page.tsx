...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className="h-screen grid grid-cols-1 md:grid-cols-2 gap-8 px-20 py-12 items-center justify-center font-sans ">
        <section className="flex flex-col items-center justify-center text-center ">
          <motion.h2
            className="text-4xl font-bold mb-6 h-1/4 "
          ...
          >
            <p className="text-xl">
              Latitude: <span className="font-bold">28.5623° N</span>,
              Longitude: <span className="font-bold">80.5774° W</span>
            </p>
        ...
        <section className="flex flex-col items-center justify-center text-center">
          ...
          >
            <p className="text-xl">
              Current Temp: <span className="font-bold">{marsTemp}</span>
            </p>
            <p className="text-lg mt-2">
              Winds: 10–20 km/h | Visibility: Clear
            </p>
          </motion.div>
        </section>
        ...
        <section className="flex flex-col items-center justify-center text-center">
          ...
          <motion.div
            className="w-full max-w-4xl p-6 rounded-lg bg-green-800 bg-opacity-20 backdrop-blur-md shadow-xl"
            initial={{ scale: 0.8, opacity: 0 }}
            whileInView={{ scale: 1, opacity: 1 }}
            transition={{ duration: 1 }}
          >
            <p className="text-xl">
              Status: <span className="font-bold">{satelliteStatus}</span>
            </p>
            <p className="text-lg mt-2">
              Battery: 87% | Signal Strength: Excellent
            </p>
          </motion.div>
        </section>
        ...
        <section className="flex flex-col items-center justify-center text-center">
          ...
          >
            <p className="text-xl">
              Active Trackers:{" "}
              <span className="font-bold">{asteroidCount}</span>
            </p>
            <p className="text-lg mt-2">
              Threat Level: Low | Nearest Pass: 0.02 AU
            </p>
          </motion.div>
        </section>
      </div>
